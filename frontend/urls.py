...
urlpatterns=[
    ...
    path('users/admin/create/user/', views.admin_create_user, name='admin_create_user'),
    path('users/admin/manage/user/', views.admin_manage_user, name='admin_manage'),
    path('users/admin/published/article/', views.admin_published_article, name='admin'),
    path('users/dashboard/editor/', views.editor_dashboard, name='editor_dashboard_editor'),
    path('users/dashboard/journalist/', views.journalist_dashboard, name='journalist_dashboard'),
